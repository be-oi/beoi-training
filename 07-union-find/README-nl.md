# Unit 7: Union Find Disjoint Sets
...
- Unit 2: [Linear data structures](../02-linear-struct/README-nl.md) (array, bitset, vector, linked list, stack, queue)
- Unit 4: [Tree data structures](../04-trees/README-nl.md) (set, map, heap)
